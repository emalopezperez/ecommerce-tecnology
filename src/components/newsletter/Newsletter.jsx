...
export default function Newsletter() {
  return (
    <div className="relative py-16 overflow-hidden bg-black isolate sm:py-24 lg:py-32 w-full">
      ...
      <div
        ...
        aria-hidden="true">
        <div
          className="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-[#ff80b5] to-[#edecf0] opacity-30"
          style={{
            clipPath:
